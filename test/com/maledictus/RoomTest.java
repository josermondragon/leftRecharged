...
public class RoomTest {
    ...
    public void setup() {
        ...
        npcMap = new HashMap<>();
        Ghost npc = new Ghost(1,100, "ghostly librarian", "A semi translucent librarian, it seems to be focused on something.", false, Species.GHOST, dialog);
    ...
    public void testRoomFactoryCreateRoom_shouldCreateListOfRooms_whenCreateRoomMethodIsCalled() {
        ...
        RoomFactory.createRoom("Cellar", "Wine and stuff.", directions, true, KeyType.DUNGEON, list);
